...
CARD_COPY = {
    "es": {
        ...
        "case_2": ("Business Intelligence y rentabilidad", "De reportar ventas a decidir con margen", "Lectura mensual de ventas, publicidad y beneficio neto estimado para priorizar el portfolio por causa, oportunidad y riesgo.", ["Caso2.jpeg"]),
        "case_3": ("Data-to-Creative · Amazon Gallery", "Información técnica convertida en una galería de decisión", "Rediseño de seis imágenes para hacer visibles especificaciones, compatibilidad y beneficios. No se publica un cambio de conversión porque no existe un test controlado en el archivo.", ["Revolution/Old Style Images/61dHW0lmqEL._AC_SL1500_.jpg", "Revolution/New Style Images/61HEg-LnYyL._AC_SL1400_.jpg"]),
        "daizzy": ("Amazon Account Management · Caso técnico", "Daizzy Gear: PPC, inventario y contenido coordinados", "Caso técnico sobre arquitectura PPC, presupuesto, inventario, promociones, A+ Content, Storefront y catálogo, con una recuperación semanal contextualizada.", ["image_060.png", "image_079.png"]),
    },
    "en": {
        ...
        "case_2": ("Business Intelligence and profitability", "From reporting sales to deciding with margin", "A monthly sales, media and estimated net-profit view used to prioritize the portfolio by cause, opportunity and risk.", ["Caso2.jpeg"]),
